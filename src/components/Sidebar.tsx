...
interface SidebarProps {
  currentView: 'todo' | 'archive' | 'dashboard' | 'raw-editor';
  onViewChange: (view: 'todo' | 'archive' | 'dashboard' | 'raw-editor') => void;
            ...
            <li>
              ...
              >
                <span className="flex items-center gap-2 truncate">
                  ...
                  <span className="truncate">{language === 'de' ? 'Direkt-Editor' : 'Raw Editor'}</span>
                </span>
              </button>
            </li>
