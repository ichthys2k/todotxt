          ...
          {activeTab === 'sync' && (
            <div className="space-y-6 animate-fade-in text-slate-650 dark:text-slate-350 leading-relaxed">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80">
                <h5 className="font-bold text-slate-800 dark:text-slate-200 mb-1">Datenschutz &amp; Cookies</h5>
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                  Du kannst deine Einstellungen für Cookies und externe Dienste jederzeit anpassen oder widerrufen.
                </p>
                <button
                  onClick={() => {
                    window.dispatchEvent(new Event('todo_txt_reopen_cookie_consent'));
                  }}
                  className="px-3.5 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-850 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl transition-all cursor-pointer bg-transparent"
                >
