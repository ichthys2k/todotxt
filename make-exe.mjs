 ...
 * make-exe.mjs
 *
 * Builds a single portable .exe using electron-builder's "portable" target.
 *
...
// ── 3. electron-builder portable EXE ─────────────────────────────────────────
console.log('\n⚙️   Erstelle portable EXE …');
...
console.log('\n✅  Fertig: dist-desktop\\TodoTxt-Windows-Portable.exe');
console.log('   → Einfach Doppelklick – keine Installation nötig!\n');
